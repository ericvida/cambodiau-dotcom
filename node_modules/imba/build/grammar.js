...
var grammar = {
  ...
  Decorator: [
    ...
    o("DecoratorIdentifier ( ArgList )", function() {
      return new Decorator(A1).set({ params: A3 });
    }),
  ...
  TagOptions: [
    ...
    o("TagOptions TAG_ON", function() {
      return A1.addPart(A2, AST.TagHandler);
    }),
  ...
  TagHandler: [
    o("DECORATOR", function() {
      return new TagHandler(new IdentifierExpression(A1.cloneSlice(1, "TAG_LITERAL")));
    }),
    o("TagHandler . IDENTIFIER", function() {
      return A1.add(A3);
    }),
    o("TagHandler CALL_START ArgList CALL_END", function() {
      return A1.add(A3, A2.generated ? AST.TagHandlerCallback : AST.TagArgList, A2, A4);
    })
  ],
  TagDeclaration: [
  ...
  ClassFieldDeclaration: [
    ...
    o("ClassFieldDeclaration @ Expression", function() {
      return A1.set({ wrapper: A3 });
    }),
    o("ClassFieldDeclaration DECORATOR WatchBody", function() {
