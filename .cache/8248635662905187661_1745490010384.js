...
class LayoutSidebarComponent extends imba_Component { // left sidebar of content
	...
	static {
		...
		imba_defineTag('layout-sidebar',this,{cssns: 'z1hr5fjj_af',cssid: 'z1hr5fjj-af'});
	}
};
...
class LayoutSidebarsComponent extends imba_Component {
	...
	static {
		...
		imba_defineTag('layout-sidebars',this,{cssns: 'z1hr5fjj_am',cssid: 'z1hr5fjj-am'});
	}
};
...
class LayoutPancakesComponent extends imba_Component {
	...
	static {
		...
		imba_defineTag('layout-pancakes',this,{cssns: 'z1hr5fjj_au',cssid: 'z1hr5fjj-au'});
	}
};
...
class LayoutHolygrailComponent extends imba_Component {
	...
	static {
		...
		imba_defineTag('layout-holygrail',this,{cssns: 'z1hr5fjj_bc',cssid: 'z1hr5fjj-bc'});
	}
};
...
class LayoutCardFlexGridComponent extends imba_Component { // repeat-auto-max
	...
	static {
		...
		imba_defineTag('layout-card-flex-grid',this,{cssid: 'z1hr5fjj-bo'});
	}
};
