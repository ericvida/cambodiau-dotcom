...
class LettersConsonantsComponent extends imba_Component {
	...
	render(){
		...
		$2 || ($6=imba_createElement('header',$1,`yafdsj-ah ${$5}`,null));
	...
	static {
		...
		imba_defineTag('letters-consonants',this,{cssns: 'yafdsj_af'});
	}
};

imba_styles.register('yafdsj',"header.yafdsj_af:not(#_) {display: flex;\nflex-direction: row;\ngap: var(--u_sp,1sp);\n--u_rg: var(--u_sp,1sp);\n--u_cg: var(--u_sp,1sp);}\nheader.yafdsj_af h2.yafdsj_af:not(#_) {flex-grow: 1;}\nheader.yafdsj_af .yafdsj_af.options:not(#_) {display: flex;}\n\n.yafdsj_af.option:not(#_) {background: hsla(240.00,5.88%,90.00%,100%);\npadding-left: var(--u_sp,1sp);\npadding-right: var(--u_sp,1sp);}\n.yafdsj_af.option.\\@darkmode:not(#_) {background: hsla(240.00,3.70%,15.88%,100%);}\n.yafdsj_af.option:first-child:not(#_) {border-top-left-radius: var(--u_rd,1rd);\nborder-bottom-left-radius: var(--u_rd,1rd);}\n.yafdsj_af.option:last-child:not(#_) {border-top-right-radius: var(--u_rd,1rd);\nborder-bottom-right-radius: var(--u_rd,1rd);}\n\nbutton.yafdsj_af.active-button:not(#_) {background: hsla(var(--hue3),1);}\nbutton.yafdsj_af.active-button.\\@darkmode:not(#_) {background: hsla(var(--hue8),1);}\n\n.yafdsj_af.letter-grid:not(#_) {display: grid;\ngrid-auto-flow: row;\ngrid-template-columns: 1fr 1fr 1fr 1fr 1fr 1fr;\ngap: var(--u_sp,1sp);\n--u_rg: var(--u_sp,1sp);\n--u_cg: var(--u_sp,1sp);}\n\n.yafdsj_af.letter:not(#_) {padding: var(--u_sp,1sp);\nborder-radius: var(--u_rd,1rd);\ndisplay: flex;\nalign-items: center;\njustify-content: center;\nwidth: calc(var(--u_sp,1sp) * 4);\nheight: calc(var(--u_sp,1sp) * 4);\ncursor: pointer;}\n.yafdsj_af.letter:is(:hover,.\\@hover):not(#_) {opacity: 90%;}\n\n.yafdsj_af.kh:not(#_) {font-family: 'Open Khmer School';\nfont-size: 24px;\nline-height: 36px;\n--u_lh: 36px;}\n\n.yafdsj_af.group-0:not(#_) {user-select: none;\n-webkit-user-select: none;}\n\n.yafdsj_af.group-1:not(#_) {background: hsla(228.00,96.49%,88.82%,100%);\ncolor: hsla(242.17,47.43%,34.31%,100%);}\n.yafdsj_af.group-1.\\@darkmode:not(#_) {background: hsla(242.17,47.43%,34.31%,100%);\ncolor: hsla(228.00,96.49%,88.82%,100%);}\n\n.yafdsj_af.group-2:not(#_) {background: hsla(352.65,96.08%,90.00%,100%);}\n.yafdsj_af.group-2.\\@darkmode:not(#_) {background: hsla(343.40,79.66%,34.71%,100%);}\n\n.yafdsj_af.group-3:not(#_) {background: hsla(228.00,96.49%,88.82%,50%);\ncolor: hsla(242.17,47.43%,34.31%,100%);}\n.yafdsj_af.group-3.\\@darkmode:not(#_) {background: hsla(242.17,47.43%,34.31%,50%);\ncolor: hsla(228.00,96.49%,88.82%,100%);}\n.yafdsj_af.group-3.sub:not(#_) {border-style: none;\nbackground: hsla(240.00,5.88%,90.00%,100%);}\n.yafdsj_af.group-3.sub.\\@darkmode:not(#_) {background: hsla(240.00,3.70%,15.88%,100%);}\n\n.yafdsj_af.group-4:not(#_) {background: hsla(352.65,96.08%,90.00%,50%);}\n.yafdsj_af.group-4.\\@darkmode:not(#_) {background: hsla(341.54,75.48%,30.39%,50%);}\n.yafdsj_af.group-4.sub:not(#_) {border-style: none;\nbackground: hsla(240.00,5.88%,90.00%,100%);}\n.yafdsj_af.group-4.sub.\\@darkmode:not(#_) {background: hsla(240.00,3.70%,15.88%,100%);}\n\n.yafdsj-ah:not(#_):not(#_):not(#_) {display: flex;\nflex-direction: row;}\n\nletters-consonants { display:block; }");
/*
header.yafdsj_af:not(#_) {display: flex;
flex-direction: row;
gap: var(--u_sp,1sp);
--u_rg: var(--u_sp,1sp);
--u_cg: var(--u_sp,1sp);}
