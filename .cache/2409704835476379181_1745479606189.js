...
class LettersChartComponent extends imba_Component {
	...
	static {
		...
		imba_defineTag('letters-chart',this,{cssns: 'z1ltrz1l_af',cssid: 'z1ltrz1l-af'});
	}
};
...
class LettersNavComponent extends imba_getSuperTagType('nav','HTMLElement',imba_Component) {
	...
	static {
		...
		imba_defineTag('letters-nav',this,{extends: 'nav',cssns: 'z1ltrz1l_aw',cssid: 'z1ltrz1l-aw'});
	}
};

imba_styles.register('z1ltrz1l',".z1ltrz1l-af {display: flex;\nflex-direction: column;\nmin-height: calc(100vh - var(--u_topbar,1topbar));}\n\n.z1ltrz1l_af.nav-wrapper:not(#_) {display: grid;\ngrid-auto-flow: column;\ngrid-auto-columns: 1fr;\npadding: var(--u_sp,1sp);\nmin-width: 1000px;\nmax-width: 1000px;\nmargin-left: auto;\nmargin-right: auto;}\n\n.z1ltrz1l_af.wrapper:not(#_) {display: grid;\ngrid-auto-flow: column;\ngrid-auto-columns: 1fr;\ngap: var(--u_sp,1sp);\n--u_rg: var(--u_sp,1sp);\n--u_cg: var(--u_sp,1sp);\ngrid-template-columns: 3fr 1fr;\npadding: var(--u_sp,1sp);\nwidth: 1000px;\nmargin-left: auto;\nmargin-right: auto;}\n\n.z1ltrz1l_af.collection-grid:not(#_) {display: grid;\ngrid-template-columns: 1fr;\ngap: var(--u_sp,1sp);\n--u_rg: var(--u_sp,1sp);\n--u_cg: var(--u_sp,1sp);\nwidth: 100%;}\n\n.z1ltrz1l_af.rightbar:not(#_) {display: flex;\nflex-direction: column;\ngap: var(--u_sp,1sp);\n--u_rg: var(--u_sp,1sp);\n--u_cg: var(--u_sp,1sp);}\n\nletters-chart { display:block; }\n\n.z1ltrz1l-aw {width: 100%;}\n\nul.z1ltrz1l_aw:not(#_) {display: flex;\njustify-content: space-between;\njustify-items: space-between;\nwidth: 100%;\ngap: var(--u_sp,1sp);\n--u_rg: var(--u_sp,1sp);\n--u_cg: var(--u_sp,1sp);}\n\nli.z1ltrz1l_aw:not(#_) {background: hsla(240.00,4.88%,83.92%,100%);\npadding-left: var(--u_sp,1sp);\npadding-right: var(--u_sp,1sp);\nborder-radius: var(--u_rd,1rd);}\n\nletters-nav { display:block; }");
/*
.z1ltrz1l-af {display: flex;
flex-direction: column;
min-height: calc(100vh - var(--u_topbar,1topbar));}
