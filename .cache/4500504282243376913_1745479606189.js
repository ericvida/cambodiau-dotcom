...
class LettersVowelsComponent extends imba_Component {
	...
	static {
		...
		imba_defineTag('letters-vowels',this,{cssns: 'z1ql6hzl_af'});
	}
};

imba_styles.register('z1ql6hzl',".z1ql6hzl_af.letter-grid:not(#_) {display: grid;\ngrid-auto-flow: row;\ngrid-template-columns: 1fr 1fr 1fr 1fr 1fr 1fr;\ngap: var(--u_sp,1sp);\n--u_rg: var(--u_sp,1sp);\n--u_cg: var(--u_sp,1sp);}\n\n.z1ql6hzl_af.letter:not(#_) {padding: var(--u_sp,1sp);\nborder-radius: var(--u_rd,1rd);\ndisplay: flex;\nalign-items: center;\njustify-content: center;\nwidth: calc(var(--u_sp,1sp) * 4);\nheight: calc(var(--u_sp,1sp) * 4);\ncursor: pointer;}\n.z1ql6hzl_af.letter:is(:hover,.\\@hover):not(#_) {opacity: 90%;}\n\n.z1ql6hzl_af.group-1:not(#_) {background: hsla(228.00,96.49%,88.82%,100%);}\n\n.z1ql6hzl_af.group-2:not(#_) {background: hsla(352.65,96.08%,90.00%,100%);}\n\n.z1ql6hzl_af.consonant-options:not(#_) {display: flex;\njustify-content: space-between;}\n\nletters-vowels { display:block; }");
/*
.z1ql6hzl_af.letter-grid:not(#_) {display: grid;
grid-auto-flow: row;
grid-template-columns: 1fr 1fr 1fr 1fr 1fr 1fr;
gap: var(--u_sp,1sp);
--u_rg: var(--u_sp,1sp);
