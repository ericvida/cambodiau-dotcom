...
class Api
	...
	def calcAllProgress
		state.learning_data.user_progress = calcUserProgress(courses_data)
		state.learning_data.user_progress_learned_usage = calcUserLearnedUsage(courses_data)
		state.learning_data.course_progress = calcCourseProgress(courses_data)
		state.learning_data.course_learned_usage = calcCourseLearnedUsage(courses_data)
		state.learning_data.lesson_progress = calcLessonProgress(courses_data)
		state.learning_data.lesson_learned_usage = calcLessonLearnedUsage(courses_data)
		state.learning_data.phrase_progress = calcPhraseProgress(courses_data)
		state.learning_data.phrase_learned_usage = calcPhraseLearnedUsage(courses_data)
