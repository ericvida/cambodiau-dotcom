tag left-navitem
	...
	css self 
		d:hflex .collection_active:vflex g:1sp ai:center p:1sp
	...
	def render
		<self .locked=locked .collection_active=collection_active>
