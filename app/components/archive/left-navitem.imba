tag left-navitem
	...
	css self 
		d:hflex .moduul_active:vflex g:1sp ai:center p:1sp
	...
	def render
		<self .locked=locked .moduul_active=moduul_active>
			...
			<.moduul-info>
				<.moduul-stats>
					<h2.moduul-name>
						<slot>
						<span[ml:0.3sp]> "{name}"
					<.moduul-wordcount[ta:right]>
						<div> progress
				# let active = self.flags.contains('active')
				<progress-bar[hue:indigo $bg:gray3 @darkmode:gray7]=moduul_active progress=progress>
